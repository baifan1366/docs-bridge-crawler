...
function findSectionByHeading($: cheerio.CheerioAPI, keywords: string[]): cheerio.Cheerio<any> | null {
...
function extractListItems($: cheerio.CheerioAPI, section: cheerio.Cheerio<any>): string[] {
  const items: string[] = [];
